...
if(userAge < '18') {
    userTicketPrice = 'Hai meno di 18 anni, quindi puoi usufruire del 20% di sconto! Il prezzo del tuo viaggio è pari ad euro  ' + (userSubtotal - discountOver18).toFixed(2) + ' .Grazie per aver scelto JSItalia!'
} else if(userAge > '65') {
    userTicketPrice = 'Ha più di 65 anni, quindi può usufruire del 40% di sconto! Il prezzo del suo viaggio è pari ad euro  ' + (userSubtotal - discountOver65).toFixed(2) + ' .Grazie per aver scelto JSItalia!'
} else {
